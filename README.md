...
- 📐 **照投影施工**——装了 Litematica（Forge 上是 Forgematica）时，你在游戏里放好的那张投影，它直接读得到：哪个图纸、摆在哪一格、转过多少、要不要镜像，全是你屏幕上那一份。说一句"照我投影盖"就行，坐标不用你念，也不会念错。详见 [Litematica 联动](docs/LITEMATICA.md)。
