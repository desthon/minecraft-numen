...
public final class MoveToTool implements NumenTool {
    ...
    public String description() {
        return """
                ...
                FLYING: this tool always walks (or swims, or boats). If I am allowed to fly (creative mode — check get_self_status), fly_to crosses open ground in a straight line and is the faster answer; use goto when the way is indoors, underground, or blocked from the air. Note what a fly_to leaves behind: by default she HOVERS over the column she flew to, so calling goto after one is normal — this call replaces that hold and she comes down and walks, no separate "land first" step needed.
