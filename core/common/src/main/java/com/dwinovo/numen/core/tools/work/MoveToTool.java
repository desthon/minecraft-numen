...
public final class MoveToTool implements NumenTool {
    ...
    public String description() {
        return """
                ...
                VEHICLES: sitting in a boat when you call this, she pilots it over the water toward the target — a destination on the water keeps her aboard, a destination ashore has her step off at the shore and finish on foot. Not in a boat, but facing a wide stretch of open water with a boat in her pack, she walks to the water's edge, launches the boat, rows across and walks the rest; if any of that does not work out she swims/walks it instead and says so. Any other vehicle is stepped off the moment walking begins. Boarding is interact_entity right on the boat.
